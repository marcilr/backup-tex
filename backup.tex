...
pdftitle={bsdinspect database tables},
pdfcreator={ps2pdf},
pdfsubject={bsdinspect database},
pdfkeywords={bsdinspect, database, tables, structure}
]{hyperref}
...
%%
\usepackage{svninfo}
\svnInfo $Id: backup.tex 8 2012-11-11 21:41:52Z marcilr $
