...
%% 
%% Date-stamped Backups Implemented with Hardlinks and Rsync
%%
...
pdftitle={Date-stamped Backups using Hardlinks and Rsync},
pdfcreator={ps2pdf},
pdfsubject={Date-stamped Backups using Hardlinks and Rsync},
